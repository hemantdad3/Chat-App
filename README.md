...
- **Frontend (Vercel)**: [https://your-chat-app.vercel.app](https://your-chat-app.vercel.app) *(Coming in Phase 7)*
- **Backend API (Render)**: [https://your-chat-api.onrender.com](https://your-chat-api.onrender.com) *(Coming in Phase 7)*
